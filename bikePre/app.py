...
@st.cache_resource
def load_model():
    data = joblib.load('model_compressed.pkl')
    return data['model'], data['feature_cols'], data['df_raw']
...
# Load pre-trained model instantly (no training on cloud)
model, feature_cols, df_raw = load_model()
